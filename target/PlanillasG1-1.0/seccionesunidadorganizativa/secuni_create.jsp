        ...
        <main class="bg-slate-100">
            ...
            <section class="container bg-white h-[600vh] min-h-full max-h-screen">
                ...
                <div class="container text-center py-8">
                    ...
                    <h1 class="font-bold text-2xl md:text-3xl border-b-2 pb-4 border-[#80BF96] text-[#629c76]">Formulario de creacion de seccion</h1>
    
                </div>

                <form action="secuni_store.jsp" method="post" class="grid md:grid-cols-2 gap-2">
                    
                    <div class="flex flex-col gap-2 px-4">

                        <label>Nombre:</label>
                        <input class="border rounded-lg py-1 px-4 w-full" type="text" name="NOMBRESECCIONUNIORG" required>
