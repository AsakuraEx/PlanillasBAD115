        ...
        <main class="bg-slate-100">
            ...
            <section class="container bg-white h-[600vh] min-h-full max-h-screen">
                ...
                <div class="container text-center py-8">
                    ...
                    <h1 class="font-bold text-2xl md:text-3xl border-b-2 pb-4 border-[#80BF96] text-[#629c76]">Formulario de actualizacion de profesioness</h1>
                ...
                <form action="profesion_update.jsp" method="post">
                    ...
                    <div class="flex flex-col gap-2 px-4">
                        ...
                        <input class="border rounded-lg py-1 px-4 w-full" type="text" name="nombreprofesion" value="<%=profesion.getNombreprofesion() %>" required>
                ...
                <div class="md:mx-auto flex justify-center py-12">
                    ...
                    <a class="bg-gray-900 text-white hover:bg-gray-500 py-2 px-4 text-center rounded" href="./profesion_index.jsp">Regresar al listado</a>
