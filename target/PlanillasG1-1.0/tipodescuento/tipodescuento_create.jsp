            ...
            <section class="container bg-white h-[600vh] min-h-full max-h-screen">
                ...
                <form action="tipodescuento_store.jsp" method="post" class="grid md:grid-cols-2 gap-2">
                    ...
                    <div class="container text-center py-4 md:col-span-2">
                        ...
                        <input class="border rounded-lg py-1 px-4 w-full text-center" type="text" id="porcentaje" name="porcentaje" required disabled value="0.0" pattern="^(0\.[0-9]{1,2}[1-9]|[1-9]\d?(\.\d{1,2})?|100(\.0{1,2})?)$" placeholder="0.01 - 100" style="display: none;" title="Ingrese valores entre 0.01 y 100">    
                    </div>
