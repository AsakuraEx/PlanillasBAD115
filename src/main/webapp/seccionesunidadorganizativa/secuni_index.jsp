        ...
        <main class="bg-slate-100">
            ...
            <section class="container bg-white h-screen">
                ...
                <div class="container text-center py-8">
                    ...
                    <h1 class="font-bold text-2xl md:text-3xl border-b-2 pb-4 border-[#80BF96] text-[#629c76]">Secciones de unidades organizativas</h1>
                ...
                <div class="flex justify-center items-center md:justify-start mb-8">
                    ...
                    href="secuni_create.jsp">Crear nueva seccion</a>
                ...
                <div class="overflow-x-auto px-8 pb-8">
                     ...
                     <table id="example" class="table-auto mx-auto md:w-full">
                        <thead class="text-center border-b-2 border-slate-600 py-3 px-8">
                            <td class="px-2 py-2">Nombre de Seccion</td>
                            <td class="px-2 py-2">Area Asociada</td>
                        ...
                        <tbody>
                            ...
                            <tr class="text-center border-b border-slate-400">
                                <td class="px-8 py-2 md:px-1"><%=seccion.getNOMBRESECCIONUNIORG()%></td>
                                
                                <% 
                                    uni = controller1.search(seccion.getID_AREAUNIDADORG());
                                %>
                                <td class="px-8 py-2 md:px-1"><%= uni.getNOMBREAREAUNIDADORG()%></td>
